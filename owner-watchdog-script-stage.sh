...
GRPC_KAFKA_SERVICE_NAME="owner-stage"
...
SECRET_AND_TOPIC_KEY_LIST=(
    "VYBE_TRADE_PRODUCER-STAGE-GKE-ACCOUNT|KAFKA_TOPIC"
    "VYBE_TRADE_PRODUCER-STAGE-GKE-MARKET-LIQUIDITY-ACCOUNT|KAFKA_TOPIC_1"
)
