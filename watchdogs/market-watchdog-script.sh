...
GRPC_KAFKA_SERVICE_NAME="market"

STATE_FILE_PATH="/dragon/watchdogs/acc-failover/market-watchdog.state"
...
SECRET_AND_TOPIC_KEY_LIST=(
    "VYBE_TRADE_PRODUCER-PROD-GKE-MARKET-ACCOUNT|KAFKA_TOPIC"
    "VYBE_LIVE_AGGREGATOR_PROD|KAFKA_ACCOUNT_TOPIC"
    "VYBE_TRADE_PRODUCER-PROD-GKE-MARKET-LIQUIDITY-ACCOUNT|KAFKA_TOPIC"
)
