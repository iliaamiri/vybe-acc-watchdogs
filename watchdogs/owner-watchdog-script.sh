...
GRPC_KAFKA_SERVICE_NAME="owner"

STATE_FILE_PATH="/dragon/watchdogs/acc-failover/owner-watchdog.state"
...
SECRET_AND_TOPIC_KEY_LIST=(
    "VYBE_TRADE_PRODUCER-PROD-GKE-ACCOUNT|KAFKA_TOPIC"
    "VYBE_TRADE_PRODUCER-PROD-GKE-MARKET-LIQUIDITY-ACCOUNT|KAFKA_TOPIC_1"
)
